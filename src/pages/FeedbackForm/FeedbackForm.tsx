...
import { Button, Comment, Question } from "../../components";

interface FeedbackFormProps {
	setState: React.Dispatch<
		React.SetStateAction<"loading" | "error" | "form" | "success">
	>;
}
...
export function FeedbackForm({ setState }: FeedbackFormProps) {
	...
	const submitFeedback = () => {
		...
		axios
			.patch(`${import.meta.env.VITE_API_URL}/submit_feedback/${id}`, {
				coaching: feedback["1"],
				project_management: feedback["2"],
				four_pillars: feedback["3"],
				communication: feedback["4"],
	...
	return (
		<div className="container">
			...
			<p className="context">
				Following your last session, please score you Academy Coach according to
				their current performance. This is what the scores will mean:
				<ol>
					<li>
				...
				We appraise all CP+R coaches using this scoring system. Level 3 and
				above is the expectation and in this way, Academy Coaches will be ready
				to graduate when they achieve at least a 3 in all the coaching areas
				below. <br />
				<br />
				In the first few sessions, it may not be possible for you to comment yet
				on how the individual is performing, there you can select N/A. After the
				first week of training, you should be able to score them in all 4 areas.
				<br />
				<br /> The scores can only be viewed by the CCA manager, who will review
				and use this to help support and develop the Academy Coach.
			</p>
			<hr />
			<Question
			...
			<div className="button-cont">
				...
				<Button
					valid={Object.values(feedback).every((x) => x !== null) && !loading}
